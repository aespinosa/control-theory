...
\startmode[presentation]
  ...
  \startsetups[footer]
    \externalfigure[engineyard-logo][height=14pt]
  \stopsetups
  \setupfootertexts[@AllanEspinosa][\setup{footer}]
\stopmode
...
\midaligned{\externalfigure[engineyard-logo][width=0.3\textwidth]}
\vfill
\stopSlide
...
\dontleavehmode
\externalfigure[engineyard-logo][width=0.4\textwidth]
\hfill
...
\startSlide
\vfill
\externalfigure[trial.pdf][width=\textwidth]
\vfill
\stopSlide
...
\midaligned{
\externalfigure[http://akamaicovers.oreilly.com/images/9780596518585/lrg.jpg][width=0.54\textwidth]
}
...
\startitemize
  ...
  \item correct a system based on its output
\stopitemize
...
\externalfigure[maxwell.pdf][page=2,width=0.98\textwidth]
...
\startitemize[columns]
  \item Regulatory Control
  \item Disturbance rejection
\stopitemize

\externalfigure[scaling.pdf][width=\textwidth]
...
%\externalfigure[settling.pdf][width=0.5\textwidth]
...
drawarrow (0,-3.3u) -- (20u, -3.3u);
drawarrow (0,-3.3u) -- (0, 2u);
...
\externalfigure[nonlinear.pdf][width=\textwidth]
...
\dontleavehmode
\externalfigure[https://images-na.ssl-images-amazon.com/images/I/41iAmXZ8zbL.jpg][width=0.4\textwidth]
\hfill
\externalfigure[https://images-na.ssl-images-amazon.com/images/I/41Lg4IZz+nL.jpg][width=0.4\textwidth]

\stopSlide

\startSlide
\vfill
\midaligned{ \externalfigure[raffle.pdf][width=0.7\textwidth] }
\vfill
\stopSlide
...
\midaligned{
\useURL[eysurvey]{https://ey.io/EYprize}
\from[eysurvey]
}
\vfill
{\tfxx
